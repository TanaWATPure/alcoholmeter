...
<div class="container">
    ...
    <h1 class="text-center"><i class=""></i> Data Alcohol Panel </h1>

    <div class="row mb-3">
        <div class="col-md-12"> <input type="text" class="form-control" placeholder="ค้นหา ชื่อ เลขประจำตัว" id="searchInput">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-12"> 
